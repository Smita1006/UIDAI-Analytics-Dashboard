      ...
      <CardContent className="space-y-4">
        ...
        <div className="space-y-2">
          ...
          <div className="grid grid-cols-2 gap-2">
            <Button
              variant={filters.dateRange?.start === '2025-03-01' ? 'default' : 'outline'}
              size="sm"
              onClick={() => handleDateRangeChange({ start: '2025-03-01', end: '2025-03-09' })}
            >
              All Data
            </Button>
            <Button
              variant={filters.dateRange?.start === '2025-03-07' ? 'default' : 'outline'}
              size="sm"
              onClick={() => handleDateRangeChange({ start: '2025-03-07', end: '2025-03-09' })}
            >
              Last 3 Days
            </Button>
          </div>
